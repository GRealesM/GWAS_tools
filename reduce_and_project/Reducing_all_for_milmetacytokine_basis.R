...
load("../milmetacytokine_basis/milmetacytokine-basis-sparse-1.0.RData")
...
write.table(M, paste("../milmetacytokine_basis/reduced_datasets/",newname,"-ft.tsv", sep = ""), quote = FALSE, row.names = FALSE, sep = "\t")
cat("Done!\n")
