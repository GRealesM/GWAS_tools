...
# Introduction: This code is meant to pre-process our big files (located at 02-Liftovered/), filtering them by the SNPs in the SNP manifest, to make them more manageable prior to project them onto the cytokine13 basis.
...
write.table(M, paste("~/rds/rds-cew54-basis/03-Bases/cytokine13_basis/reduced_datasets/",newname,"-ft.tsv", sep = ""), quote = FALSE, row.names = FALSE, sep = "\t")
cat("Done!\n")
